...
# Declaration of AI
  ...
  AI models (such as ChatGPT, CoPilot and Grammarly) have been used as an assistance tool when coding models,  understanding python packages and increasing readibility of code.  It was also used to assist in improving grammar and readability when writting up the report.
